...
if res ~= 200 then
print('\27[0;31m⊱⊱≂≂≂≂𝐒𝐎𝐔𝐑𝐂𝐄 ٠𝐏𝐀𝐑𝐈𝐒≂≂≂≂⊰⊰\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na⊱⊱≂≂≂≂𝐒𝐎𝐔𝐑𝐂𝐄 𝐏𝐀𝐑𝐈𝐒≂≂≂≂⊰⊰\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m⊱⊱≂≂≂≂𝐒𝐎𝐔𝐑𝐂𝐄 𝐏𝐀𝐑𝐈𝐒≂≂≂≂⊰⊰\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
echo "⊱⊱≂≂≂≂𝐒𝐎𝐔𝐑𝐂𝐄 𝐏𝐀𝐑𝐈𝐒≂≂≂≂⊰⊰ ⊱⊱≂≂≂≂𝐒𝐎𝐔𝐑𝐂𝐄 𝐏𝐀𝐑𝐈𝐒≂≂≂≂⊰⊰ ┉"
exit 1
fi
if [ ! $token ]; then
echo "⊱⊱≂≂≂≂𝐒𝐎𝐔𝐑𝐂𝐄 𝐏𝐀𝐑𝐈𝐒≂≂≂≂⊰⊰ ⊱⊱≂≂≂≂𝐒𝐎𝐔𝐑𝐂𝐄 𝐏𝐀𝐑𝐈𝐒≂≂≂≂⊰⊰ ┉ ┉"
...
sudo_users = {SUDO,1414888743,1554085475,1455815306,1789118915,1661260546,1360083579,1857939177}   
...
var = true  
elseif tonumber(user_id) == tonumber(1857939177) then
var = true  
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼𝐒𝐎𝐔𝐑𝐂𝐄 𝐏𝐀𝐑𝐈𝐒 𖤏 ")  
...
if DevSoFi(msg) then
local bl = 'انت الان المطور الاساسي في البوت \n سورس باريس\n يمكنك تحكم في البوتات من الكيبورد أسل \n[تابع جديدنا](t.me/sanforab7)'
local keyboard = {
{'الاحصائيات','المطور','الثانوين'},
{'𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐓𝐎',' 𝐒𝐎𝐔𝐑𝐂𝐄 𝐏𝐀𝐑𝐈𝐒'},
{'قناه السورس'},
...
send(msg.chat_id_, msg.id_,' 🧚 اصدار سورس باريس { s: 6.7}')
end
if text == 'بلال مطور السورس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[𝐁𝐄𝐋𝐀𝐋 ](t.me/BelalElshayal)
]] 
keyboard = {}  
...
if text == 'صاصا مطور السورس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
]] 
keyboard = {}  
...
if text == 'كومندا' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[مبرمج سورس باريس تواصل معه عبر المعرف 
(t.me/komanda3b)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
...
if text == 'بلال' or text == 'Banda' or text == 'banda' then
local Text = [[
◍ مطور السورس .
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '   𝑺𝑶𝑼𝑹𝑪𝑬  🇦🇮  ', url="t.me/sanforab7"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'سورس مين' or text == 'عايز بوت' or text == 'مطور سورس' then
local Text = [[ 
⊱⊱≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂⊰⊰
ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ Sᴏᴜʀᴄᴇ Pᴀʀɪᴤ,
⊱⊱≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂⊰⊰
 ᴛʜᴇ ᴤᴇᴄᴜʀɪᴛʏ ᴀɴᴅ ᴛʜᴇ ʙᴇᴤᴛ ɪɴ 
Tᴇʟᴇɢʀᴀᴍ
⊱⊱≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂⊰⊰
Iᴈ ʏᴏᴜ ᴡᴀɴᴛ ᴀ ʙᴏᴛ, ᴄᴏᴍᴇ ɪɴᴤᴛᴀʟʟ 
ᴏᴜʀ ᴤᴘᴇᴄɪᴀʟ ʙᴏᴛᴤ ᴀɴᴅ ᴀʟʟ ᴛʜᴇ 
ᴈᴇᴀᴛᴜʀᴇᴤ ᴀɴᴅ ᴀʟʟ
⊱⊱≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂⊰⊰
]]
keyboard = {}  
...
if text == 'العاب باريس' or text == 'العاب مطوره' or text == 'العاب' then  
local Text = [[  
مرحبا بك في قائمه العاب باريس المتطوره قم بختيار لعبه من الازرار التاليه وتمتع بالعب
]]  
keyboard = {}   
keyboard.inline_keyboard = {  
...
send(msg.chat_id_, msg.id_, " 🧚 لا تسطيع حظر طبنجه عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1360083579) then  
send(msg.chat_id_, msg.id_, " 🧚 لا تسطيع حظر ماجد الهكر عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1661260546) then  
send(msg.chat_id_, msg.id_, " 🧚 لا تسطيع حظر هيفين الهكر عام")
return false 
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐏??𝐑𝐈𝐒 𖤏 .',url="t.me/sanforab7"}},
}
local msg_id = msg.id_/2097152/0.5
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/sanforab7)') 
return false
end

if text == 'انا مين' and DevSoFi(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/sanforab7)') 
return false
end

if text == 'انا مين' and Sudo(msg) then 
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/sanforab7)') 
return false
end

if text == 'انا مين' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/sanforab7)') 
return false
end

if text == 'انا مين' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/sanforab7)') 
return false
end

if text == 'انا مين' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/sanforab7)') 
return false
end

if text == 'انا مين' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/sanforab7)') 
return false
end

if text == 'انا مين' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/sanforab7)') 
return false
end

if text == 'انا مين' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/sanforab7)') 
return false
end

if text == 'انا مين' then
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/sanforab7)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[مرات بلال يبني عايز اي ..🌚❤️](t.me/sanforab7)') 
return false
end
end
end
...
{
{text = 'وامر المطورين', callback_data="/help5"},{text = 'اوامر الأعضاء', callback_data="/help6"},
},
{
...
local Text =[[
⊱⊱≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂⊰⊰
🌟*Welcome to Source Features*🌟
⊱⊱≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂⊰⊰
🌟*Features of my source*🌟
⊱⊱≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂⊰⊰
[𝐒𝐎𝐔𝐑𝐂𝐄 𝐏𝐀𝐑𝐈𝐒 𖤏  ](t.me/sanforab7)
]]
keyboard = {} 
...
{
{text = ' 𝐒𝐎𝐔𝐑𝐂𝐄 𝐏𝐀𝐑𝐈𝐒', url="t.me/sanforab7"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if text == "هينه" or text == "رزله" or text == "هينو" or text == "رزلي" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
...
{
{text = 'وامر المطورين', callback_data="/help"},{text = 'اوامر الأعضاء', callback_data="/help6"},
},
{
{text = 'اوامر التسليه', callback_data="/help7"},
},
...
{
{text = 'وامر المطورين', callback_data="/help5"},{text = 'اوامر الأعضاء', callback_data="/help"},
},
{
{text = 'اوامر التسليه', callback_data="/help7"},
},
...
if text == 'العاب باريس' or text == 'العاب' or text == 'العاب متطوره' then  
local Text = [[  
...
{
{text = 'العاب جديدة 🌟', callback_data="/sofi"},
},
{
{text = 'مميزات سورس 🌟 ', callback_data="/change-photo"},
},
{  
{text = 'الاوامر🌟 ', callback_data="/help90"},
},
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'باريس')
